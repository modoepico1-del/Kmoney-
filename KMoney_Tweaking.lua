...
local optimizeLabel, optimizeTrack, optimizeThumb = makeOptionRow(ContentArea, "OPTIMIZE", 334)
...
optimizeTrack.MouseButton1Click:Connect(function()
    optimizeOn = not optimizeOn
    if optimizeOn then
        toggleOn(optimizeLabel, optimizeTrack, optimizeThumb)
        enableOptimizer()
    else
        toggleOff(optimizeLabel, optimizeTrack, optimizeThumb)
        disableOptimizer()
    end
end)
